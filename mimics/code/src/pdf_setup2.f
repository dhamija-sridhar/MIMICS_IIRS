        SUBROUTINE PDF_BR3_SETUP(n_theta_1,t_rad_start_1,t_rad_stop_1,
...
C
        WORK = PI/180.
C
        if((i_pdf_br_3.eq.1).or.(i_pdf_br_3.eq.2))then
c
            t_deg_start_1 = 2.5
            t_deg_stop_1  = 27.5
            delta_t_deg_1 = 5.0
...
C-----------------------------------------------------------------------
C
        else if((i_pdf_br_3.eq.4).or.(i_pdf_br_3.eq.5))then
c
            t_deg_start_1 = 2.5
            t_deg_stop_1  = 42.5
            delta_t_deg_1 = 5.0
...
C-----------------------------------------------------------------------
C
        else if((i_pdf_br_3.eq.7).or.(i_pdf_br_3.eq.8).or.
     &                                (i_pdf_br_3.eq.9))then
c
            t_deg_start_1 = 2.5
            t_deg_stop_1  = 52.5
            delta_t_deg_1 = 5.0
...
C   (4th branches)
        ...
        SUBROUTINE PDF_BR4_SETUP(n_theta_1,t_rad_start_1,t_rad_stop_1,
     & delta_t_rad_1,n_theta_2,t_rad_start_2,t_rad_stop_2,delta_t_rad_2,
     &               n_theta_3,t_rad_start_3,t_rad_stop_3,delta_t_rad_3,
     &               n_phi_1,p_rad_start_1,p_rad_stop_1,delta_p_rad_1,
     &               n_phi_2,p_rad_start_2,p_rad_stop_2,delta_p_rad_2,
...
C
        WORK = PI/180.
C
        if((i_pdf_br_4.eq.1).or.(i_pdf_br_4.eq.2))then
c
            t_deg_start_1 = 2.5
            t_deg_stop_1  = 27.5
            delta_t_deg_1 = 5.0
...
C-----------------------------------------------------------------------
C
        else if((i_pdf_br_4.eq.4).or.(i_pdf_br_4.eq.5))then
c
            t_deg_start_1 = 2.5
            t_deg_stop_1  = 42.5
            delta_t_deg_1 = 5.0
...
C-----------------------------------------------------------------------
C
        else if((i_pdf_br_4.eq.7).or.(i_pdf_br_4.eq.8).or.
     &                                (i_pdf_br_4.eq.9))then
c
            t_deg_start_1 = 2.5
            t_deg_stop_1  = 52.5
            delta_t_deg_1 = 5.0
...
c
        ...
        SUBROUTINE PDF_BR5_SETUP(n_theta_1,t_rad_start_1,t_rad_stop_1,
     & delta_t_rad_1,n_theta_2,t_rad_start_2,t_rad_stop_2,delta_t_rad_2,
     &               n_theta_3,t_rad_start_3,t_rad_stop_3,delta_t_rad_3,
     &               n_phi_1,p_rad_start_1,p_rad_stop_1,delta_p_rad_1,
     &               n_phi_2,p_rad_start_2,p_rad_stop_2,delta_p_rad_2,
...
C
        WORK = PI/180.
C
        if((i_pdf_br_5.eq.1).or.(i_pdf_br_5.eq.2))then
c
            t_deg_start_1 = 2.5
            t_deg_stop_1  = 27.5
            delta_t_deg_1 = 5.0
...
C-----------------------------------------------------------------------
C
        else if((i_pdf_br_5.eq.4).or.(i_pdf_br_5.eq.5))then
c
            t_deg_start_1 = 2.5
            t_deg_stop_1  = 42.5
            delta_t_deg_1 = 5.0
...
C-----------------------------------------------------------------------
C
        else if((i_pdf_br_5.eq.7).or.(i_pdf_br_5.eq.8).or.
     &                                (i_pdf_br_5.eq.9))then
c
            t_deg_start_1 = 2.5
            t_deg_stop_1  = 52.5
            delta_t_deg_1 = 5.0
...
c
        ...
        SUBROUTINE PDF_BR6_SETUP(n_theta_1,t_rad_start_1,t_rad_stop_1,
     & delta_t_rad_1,n_theta_2,t_rad_start_2,t_rad_stop_2,delta_t_rad_2,
     &               n_theta_3,t_rad_start_3,t_rad_stop_3,delta_t_rad_3,
     &               n_phi_1,p_rad_start_1,p_rad_stop_1,delta_p_rad_1,
     &               n_phi_2,p_rad_start_2,p_rad_stop_2,delta_p_rad_2,
...
C
        WORK = PI/180.
C
        if((i_pdf_br_6.eq.1).or.(i_pdf_br_6.eq.2))then
c
            t_deg_start_1 = 2.5
            t_deg_stop_1  = 27.5
            delta_t_deg_1 = 5.0
...
C-----------------------------------------------------------------------
C
        else if((i_pdf_br_6.eq.4).or.(i_pdf_br_6.eq.5))then
c
            t_deg_start_1 = 2.5
            t_deg_stop_1  = 42.5
            delta_t_deg_1 = 5.0
...
C-----------------------------------------------------------------------
C
        else if((i_pdf_br_6.eq.7).or.(i_pdf_br_6.eq.8).or.
     &                                (i_pdf_br_6.eq.9))then
c
            t_deg_start_1 = 2.5
            t_deg_stop_1  = 52.5
            delta_t_deg_1 = 5.0
